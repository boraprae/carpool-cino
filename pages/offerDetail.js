          ...
          <CardContent>
            ...
            >
              ...
              >
                ...
                <Typography sx={{ fontSize: "14px" }}>Service Charge</Typography>
              </Stack>
            ...
            <Grid sx={{ mt: 3 }}>
              ...
              >
                ...
                <Typography sx={{ fontSize: "16px", color: "#58CAD2", fontWeight: "bold" }}>THB 220</Typography>
              </Stack>
            </Grid>
          </CardContent>
          <CardActions>
          ...
          <CardContent>
            ...
            >
              ...
              >
                ...
                <Typography sx={{ fontSize: "14px", fontWeight: "bold" }}>Lung Too</Typography>
                <Typography sx={{ fontSize: "12px", mt: 1 }}>
                  Age
                </Typography>
                <Typography sx={{ fontSize: "14px", fontWeight: "bold" }}>90 Years old</Typography>
              </Stack>
              ...
              >
                ...
                <Typography sx={{ fontSize: "14px", fontWeight: "bold" }}>Mitsubishi</Typography>
                <Typography sx={{ fontSize: "12px", mt: 1 }}>
                  License plate number
                </Typography>
                <Typography sx={{ fontSize: "14px", fontWeight: "bold" }}>กขค 123 เชียงราย</Typography>
              </Stack>
              <Stack
                direction="column"
                justifyContent="flex-start"
              ...
              >
                ...
                <Typography sx={{ fontSize: "14px", fontWeight: "bold" }}>Blue</Typography>
              </Stack>
            </Stack>
          </CardContent>
        </Card>
